...
namespace Cinemachine.Editor
{
        ...
        : CinemachineVirtualCameraBaseEditor<CinemachineStateDrivenCamera>
    {
        ...
        private void UpdateTargetStates()
        {
            ...
            UnityEditor.Animations.AnimatorController ac = (Target.m_AnimatedTarget == null)
                ? null : Target.m_AnimatedTarget.runtimeAnimatorController as UnityEditor.Animations.AnimatorController;
        ...
        class StateCollector
        {
            ...
            public void CollectStates(UnityEditor.Animations.AnimatorController ac, int layerIndex)
            {
